...
export default function FeaturesListContainer(
  ...
  return (
    <FullWidthFlex classNames="flex-grow flex-wrap max-h-15 border text-xs bg-stone-100 dark:bg-zinc-900 border-stone-300 rounded-md p-1 gap-1 overflow-auto max-w-4xl">
