  ...
  return (
    <OverflowAuto>
      ...
      <ReadMoreSection
        ...
        content={[
          "App is designed to help quickly build a team and start playing first scenario. At the same time it gives a lot of options to build and develop individual team members for more advanced players.",
